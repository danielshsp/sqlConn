...
public interface SysaidApiService {
     ...
     * @param srId
     * @return
     *     returns java.util.List<com.ilient.api.ApiServiceRequestAttachment>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getServiceRequestAttachmentsWithoutContent", targetNamespace = "http://api.ilient.com/", className = "com.ilient.api.GetServiceRequestAttachmentsWithoutContent")
    @ResponseWrapper(localName = "getServiceRequestAttachmentsWithoutContentResponse", targetNamespace = "http://api.ilient.com/", className = "com.ilient.api.GetServiceRequestAttachmentsWithoutContentResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getListCaptionForKey", targetNamespace = "http://api.ilient.com/", className = "com.ilient.api.GetListCaptionForKey")
    @ResponseWrapper(localName = "getListCaptionForKeyResponse", targetNamespace = "http://api.ilient.com/", className = "com.ilient.api.GetListCaptionForKeyResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "addServiceRequestAttachments", targetNamespace = "http://api.ilient.com/", className = "com.ilient.api.AddServiceRequestAttachments")
    @ResponseWrapper(localName = "addServiceRequestAttachmentsResponse", targetNamespace = "http://api.ilient.com/", className = "com.ilient.api.AddServiceRequestAttachmentsResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "deleteServiceRequestAttachments", targetNamespace = "http://api.ilient.com/", className = "com.ilient.api.DeleteServiceRequestAttachments")
    @ResponseWrapper(localName = "deleteServiceRequestAttachmentsResponse", targetNamespace = "http://api.ilient.com/", className = "com.ilient.api.DeleteServiceRequestAttachmentsResponse")
     ...
     * @param fileId
     * @return
     *     returns com.ilient.api.ApiServiceRequestAttachment
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getServiceRequestAttachment", targetNamespace = "http://api.ilient.com/", className = "com.ilient.api.GetServiceRequestAttachment")
    @ResponseWrapper(localName = "getServiceRequestAttachmentResponse", targetNamespace = "http://api.ilient.com/", className = "com.ilient.api.GetServiceRequestAttachmentResponse")
